...
// Inject this into any admin page
        ...
        const sidebarHTML = `
            <aside class="admin-sidebar" id="admin-sidebar">
                <div class="sidebar-header">
                    <img src="../../assets/images/logo-main.webp" alt="CraftSoft" class="sidebar-logo">
                </div>
                <nav class="sidebar-nav">
                    <a href="../dashboard/" class="sidebar-item ${this.currentPage === 'dashboard' ? 'active' : ''}" data-section="dashboard">
                        <i class="fa-solid fa-chart-pie"></i>
                        <span>Dashboard</span>
                    </a>
                    <a href="../students/" class="sidebar-item ${this.currentPage === 'students' ? 'active' : ''}" data-section="students">
                        <i class="fa-solid fa-user-graduate"></i>
                        <span>Students</span>
                    </a>
                    <a href="../tutors/" class="sidebar-item ${this.currentPage === 'tutors' ? 'active' : ''}" data-section="tutors">
                        <i class="fa-solid fa-chalkboard-user"></i>
                        <span>Tutors</span>
                    </a>
                    <a href="../inquiries/" class="sidebar-item ${this.currentPage === 'inquiries' ? 'active' : ''}" data-section="inquiries">
                        <i class="fa-solid fa-envelope-open-text"></i>
                        <span>Inquiries</span>
                    </a>
                    <a href="../courses/" class="sidebar-item ${this.currentPage === 'courses' ? 'active' : ''}" data-section="courses">
                    ...
                    <div class="sidebar-group ${this.currentPage === 'payments' || this.currentPage === 'receipts' ? 'expanded' : ''}">
                        <a href="../payments/" class="sidebar-item has-submenu ${this.currentPage === 'payments' ? 'active' : ''}" data-section="payments">
                            <i class="fa-solid fa-money-bill-transfer"></i>
                            <span>Payments</span>
                            <i class="fa-solid fa-chevron-down submenu-arrow"></i>
                        </a>
                        <div class="sidebar-submenu">
                            <a href="../payments/receipts/" class="sidebar-subitem ${this.currentPage === 'receipts' ? 'active' : ''}" data-section="receipts">
                    ...
                    <a href="../settings/" class="sidebar-item ${this.currentPage === 'settings' ? 'active' : ''}" data-section="settings">
